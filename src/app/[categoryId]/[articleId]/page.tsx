...
import { getCurrentArticles, getPopularArticles } from '@/app/actions';
...
export async function generateMetadata({
  ...
  return {
    title: `${article.title} | ArticleAtlas`,
    description: article.description,
    openGraph: {
      title: article.title,
      description: article.description,
      url: `${process.env.SITE_URL}/${article.category.toLowerCase()}/${article.id}`,
      images: [
        {
          url: article.image,
          width: 800,
